  ...
  <!-- Jumbotron -->
        <div class="container">
          ...
          <section class="team-section text-center my-5">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  ...
                  <img src="../barberian/spike.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                  <!--  -->
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/undercut.png"  class="rounded-circle z-depth-1"
                    alt="sample avatar">
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <!-- Masukkan gambar disini -->
                  <img src="../barberian/army.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                  <!--  -->
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/bald.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/fading.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/messy.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/mohawk.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                <div class="avatar mx-auto">
                  <img src="../barberian/pompadour.png"  class="rounded-circle z-depth-1"
                    alt="Sample avatar">
                </div>
              ...
              <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                  <div class="avatar mx-auto">
                    <img src="../barberian/sidepart.png"  class="rounded-circle z-depth-1"
                      alt="Sample avatar">
                  </div>
                ...
                <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                  <div class="avatar mx-auto">
                    <img src="../barberian/twoblocks.png"  class="rounded-circle z-depth-1"
                      alt="Sample avatar">
                  </div>
                ...
                <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                    <div class="avatar mx-auto">
                      <img src="../barberian/kim.png"  class="rounded-circle z-depth-1"
                        alt="Sample avatar">
                    </div>
                  ...
                  <div class="col-lg-4 col-md-6 mb-lg-0 mb-5">
                    <div class="avatar mx-auto">
                      <img src="../barberian/quiff.png"  class="rounded-circle z-depth-1"
                        alt="Sample avatar">
                    </div>

        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top sticky">
          <div class="container">
            ...
            <div class="navbar-nav ml-auto">
                <a class="nav-item nav-link js-scroll-trigger" href="index.html">Home <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link js-scroll-trigger" href="index.html">Tentang Kami</a>
                ...
                <div class="dropdown">
                    <a class="nav-item nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" data-toggle="modal" data-target="#modalLoginForm">Masuk Sebagai Barbershop</a>
                            <a class="dropdown-item" data-toggle="modal" data-target="#modalForm">Masuk Sebagai Barberman</a>
                          </div>
                    </div>
            </div>
            </div>
...
<!-- akhir Navbar -->
            ...
            <div id="carousel-example-2" class="carousel slide carousel-fade mt-3" data-ride="carousel">
                ...
                <!--/.Carousel Wrapper-->
        <div class="container">
                <h2 class="Deskripsi mt-3">Deskripsi</h2>
